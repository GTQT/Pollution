...
public class BloodCircuit {
    public static void init() {
        ...
        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder().EUt(VA[UV]).duration(400)
                ...
                .input(BLOOD_IPS_HUMAN_BRAIN)
                .inputs(GameRegistry.makeItemStack("bloodmagic:component",26,1,null))
                .input(GTQTMetaItems.OPTICAL_TRANSISTOR,2)
                .input(GTQTMetaItems.OPTICAL_RESISTOR,4)
                .input(GTQTMetaItems.OPTICAL_DIODE,2)
                .input(GTQTMetaItems.OPTICAL_CAPACITOR,4)
                .fluidInputs(BloodPlasma.getFluid(100), Enzymesac.getFluid(10), PollutionMaterials.infused_magic.getFluid(144))
        ...
        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder().EUt(VA[UHV]).duration(400)
                ...
                .input(BLOOD_IPS_HUMAN_BRAIN)
                .inputs(GameRegistry.makeItemStack("bloodmagic:component",26,1,null))
                .input(GTQTMetaItems.SPINTRONIC_TRANSISTOR,2)
                .input(GTQTMetaItems.SPINTRONIC_RESISTOR,4)
                .input(GTQTMetaItems.SPINTRONIC_DIODE,2)
                .input(GTQTMetaItems.SPINTRONIC_CAPACITOR,4)
                .fluidInputs(BloodPlasma.getFluid(100), Enzymesac.getFluid(10), PollutionMaterials.infused_magic.getFluid(144))
        ...
        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder().EUt(VA[UEV]).duration(400)
                ...
                .input(BLOOD_IPS_HUMAN_BRAIN)
                .inputs(GameRegistry.makeItemStack("bloodmagic:component",26,1,null))
                .input(GTQTMetaItems.COSMIC_TRANSISTOR,2)
                .input(GTQTMetaItems.COSMIC_RESISTOR,4)
                .input(GTQTMetaItems.COSMIC_DIODE,2)
                .input(GTQTMetaItems.COSMIC_CAPACITOR,4)
        ...
        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder().EUt(VA[UIV]).duration(400)
                ...
                .inputs(GameRegistry.makeItemStack("bloodmagic:component",26,1,null))
                .input(GTQTMetaItems.SUPRACAUSAL_TRANSISTOR,2)
                .input(GTQTMetaItems.SUPRACAUSAL_RESISTOR,4)
                .input(GTQTMetaItems.SUPRACAUSAL_CAPACITOR,4)
                .fluidInputs(BloodPlasma.getFluid(100), Enzymesac.getFluid(10), PollutionMaterials.infused_magic.getFluid(288))
        ...
        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder().EUt(VA[UXV]).duration(400)
                ...
                .input(GTQTMetaItems.SUPRACAUSAL_TRANSISTOR,8)
                .input(GTQTMetaItems.SUPRACAUSAL_DIODE,8)
                .input(GTQTMetaItems.SUPRACAUSAL_CAPACITOR,8)
                .inputs(GameRegistry.makeItemStack("bloodmagic:component",26,1,null))
