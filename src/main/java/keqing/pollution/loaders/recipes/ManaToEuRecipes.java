...
public class ManaToEuRecipes {
    ...
    private static void mana_to_eu() {
        MANA_TO_EU.recipeBuilder()
                ...
                .duration((int) (100*POConfig.EuPerMbKqMagicRub/8192))
                .EUt(8192)
                .buildAndRegister();

        MANA_TO_EU.recipeBuilder()
                .fluidInputs(GTQTMaterials.MagicGas.getFluid(100))
                .duration((int) (100*POConfig.EuPerMbKqMagicGas/8192))
                .EUt(8192)
                .buildAndRegister();

        MANA_TO_EU.recipeBuilder()
                .fluidInputs(GTQTMaterials.MagicFas.getFluid(100))
                .duration((int) (100*POConfig.EuPerMbKqMagicFas/8192))
                .EUt(8192)
                .buildAndRegister();

        MANA_TO_EU.recipeBuilder()
                .fluidInputs(GTQTMaterials.MagicDas.getFluid(100))
                .duration((int) (100*POConfig.EuPerMbKqMagicDas/8192))
                .EUt(8192)
                .buildAndRegister();

        MANA_TO_EU.recipeBuilder()
                .fluidInputs(GTQTMaterials.MagicAas.getFluid(100))
                .duration((int) (100*POConfig.EuPerMbKqMagicAas/8192))
                .EUt(8192)
                .buildAndRegister();

        MANA_TO_EU.recipeBuilder()
                .fluidInputs(GTQTMaterials.Magic.getFluid(100))
                .duration((int) (100*POConfig.EuPerMbMagicKq/8192))
                .EUt(8192)
                .buildAndRegister();

        MANA_TO_EU.recipeBuilder()
                .fluidInputs(GTQTMaterials.Richmagic.getFluid(100))
                .duration((int) (100*POConfig.EuPerMbRichMagicKq/8192))
                .EUt(8192)
                .buildAndRegister();
