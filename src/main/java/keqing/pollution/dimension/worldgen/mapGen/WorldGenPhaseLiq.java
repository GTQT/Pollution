...
public class WorldGenPhaseLiq extends WorldGenerator {
    ...
    public WorldGenPhaseLiq() {
        this.theBlock = BlockRegistry.BETWEENSTONE;
    }
        ...
        for (int i1 = 0; i1 < 16; ++i1) {
            for (int j2 = 0; j2 < 16; ++j2) {
                for (int j1 = 4; j1 < 8; ++j1) {
                    ...
                    IBlockState ibs = world.getBlockState(bPos);
                    if (buffer[(i1 * 16 + j2) * 8 + j1] && ibs.getBlock() == BlockRegistry.BETWEENSTONE
                        ...
                        if (biomegenbase.topBlock == BlockRegistry.SILT) {
                            world.setBlockState(bPos, BlockRegistry.SILT.getDefaultState(), 2);
                        } else {
                            world.setBlockState(bPos, BlockRegistry.BETWEENSTONE.getDefaultState(), 2);
                        }
                    }
                }
            }
