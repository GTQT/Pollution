...
public class MapGenBTNBridge extends MapGenStructure
{
    ...
    {
        this.spawnList.add(new Biome.SpawnListEntry(EntityBoulderSprite.class, 8, 5, 5));
        this.spawnList.add(new Biome.SpawnListEntry(EntityBloodSnail.class, 2, 5, 5));
        this.spawnList.add(new Biome.SpawnListEntry(EntityChiromaw.class, 3, 4, 4));
    }
