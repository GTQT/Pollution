                        ...
                        for (int k1 = l2; !flag2 && k1 < i1; ++k1)
                        {
                            for (int l1 = l + 1; !flag2 && l1 >= k2 - 1; --l1)
                            {
                                if (l1 >= 0 && l1 < 128)
                                {
                                    ...
                                    if (iblockstate.getBlock() == BlockRegistry.SWAMP_WATER || iblockstate.getBlock() == BlockRegistry.STAGNANT_WATER)
                                    {
                                        flag2 = true;
                                    }
                            ...
                            for (int j3 = l2; j3 < i1; ++j3)
                            {
                                ...
                                for (int i2 = l; i2 > k2; --i2)
                                {
                                    ...
                                    if (d9 > -0.7D && d10 * d10 + d9 * d9 + d8 * d8 < 1.0D)
                                    {
                                        ...
                                        if (iblockstate1.getBlock() == BlockRegistry.BETWEENSTONE || iblockstate1.getBlock() == BlockRegistry.PITSTONE || iblockstate1.getBlock() == BlockRegistry.CRAGROCK)
                                        {
