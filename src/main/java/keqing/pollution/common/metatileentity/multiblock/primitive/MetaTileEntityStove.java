...
public class MetaTileEntityStove extends RecipeMapPrimitiveMultiblockController {

    private static final TraceabilityPredicate SNOW_PREDICATE = new TraceabilityPredicate(
            bws -> GTUtility.isBlockSnow(bws.getBlockState()));

    public MetaTileEntityStove(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, PORecipeMaps.STOVE_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityStove(metaTileEntityId);
    }
