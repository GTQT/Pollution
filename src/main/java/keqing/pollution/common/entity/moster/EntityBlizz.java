...
import keqing.pollution.common.entity.shoot.EntityBlitzBolt;
import keqing.pollution.common.entity.shoot.EntityBlizzBolt;
...
public class EntityBlizz extends EntityElemental {
    ...
    static class AIblitzBoltAttack extends EntityAIBase {
        ...
        private final EntityBlizz blitz;
        private int attackStep;
        private int attackTime;

        public AIblitzBoltAttack(EntityBlizz entity) {
            ...
            if (d0 < 4.0D) {
                ...
                if (attackTime <= 0) {
                    ...
                    if (attackStep > 1) {
                        ...
                        for (int i = 0; i < 1; ++i) {
                            EntityBlizzBolt bolt = new EntityBlizzBolt(blitz.world, blitz);
