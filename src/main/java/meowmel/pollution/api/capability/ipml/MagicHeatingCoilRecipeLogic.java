...
public class MagicHeatingCoilRecipeLogic extends MagicMultiblockRecipeLogic {

    public  MagicHeatingCoilRecipeLogic(MagicRecipeMapMultiblockController metaTileEntity) {
