...
public class SecondDegreeMaterials {
    ...
    public static void register() {
        ...
        PollutionMaterials.advanced_battery_content = new Material.Builder(getMaterialsId(), pollutionId("advanced_battery_content"))
                ...
                .iconSet(BRIGHT)
                .flags(DECOMPOSITION_BY_ELECTROLYZING)
                .components(Caesium, 6, KQGold, 2, InfusedEnergy, 1, InfusedMotion, 1)
                .build();
        ...
        //二氯二茂铪
        PollutionMaterials.HafnoceneDichloride = new Material.Builder(getMaterialsId(), pollutionId("hafnocene_dichloride"))
                .color(0xF0A274)
                .dust()
                .iconSet(DULL)
        ...
        //茂叠铪基醚
        PollutionMaterials.uOxoBisHafnoceneAzide = new Material.Builder(getMaterialsId(), pollutionId("μ_oxo_bis_hafnocene_azide"))
                .color(0xFDDD5A)
                .dust()
                .iconSet(DULL)
        ...
        //能量水晶
        PollutionMaterials.EnergyCrystal = new Material.Builder(getMaterialsId(), pollutionId("energy_crystal"))
                .color(0xF0A274)
                .dust()
                .fluid()
                .iconSet(DULL)
                .components(InfusedAir, 1, InfusedFire, 1, InfusedWater, 1, InfusedEarth, 1)
                .build()
                .setFormula("(Ae)(Fi)(Wa)(Ea)", true);

        //StarmetalAlloy
        PollutionMaterials.StarmetalAlloy = new Material.Builder(getMaterialsId(), pollutionId("starmetal_alloy"))
                .color(0xF0A274)
                .ingot().fluid()
                .iconSet(METALLIC)
                .blast(5400, MID)
