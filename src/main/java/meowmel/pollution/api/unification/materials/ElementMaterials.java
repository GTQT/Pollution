...
public class ElementMaterials {
    ...
    public static void register() {
        PollutionMaterials.InfusedAir = new Material.Builder(getMaterialsId(), pollutionId("infused_air"))
                .color(0xFEFE7D)
                .ore().dust().fluid().gem()
        ...
        PollutionMaterials.InfusedFire = new Material.Builder(getMaterialsId(), pollutionId("infused_fire"))
                .color(0xFE3C01)
                .ore().dust().fluid().gem()
                .flags(CRYSTALLIZABLE, GTQTMaterialFlags.GENERATE_BOULE)
                .iconSet(MaterialIconSet.SHINY)
        ...
        PollutionMaterials.InfusedWater = new Material.Builder(getMaterialsId(), pollutionId("infused_water"))
                .color(0x0090FF)
                .ore().dust().fluid().gem()
                .flags(CRYSTALLIZABLE, GTQTMaterialFlags.GENERATE_BOULE)
                .iconSet(MaterialIconSet.SHINY)
        ...
        PollutionMaterials.InfusedEarth = new Material.Builder(getMaterialsId(), pollutionId("infused_earth"))
                .color(0x00A000)
                .ore().dust().fluid().gem()
                .flags(CRYSTALLIZABLE, GTQTMaterialFlags.GENERATE_BOULE)
                .iconSet(MaterialIconSet.SHINY)
        ...
        PollutionMaterials.InfusedEntropy = new Material.Builder(getMaterialsId(), pollutionId("infused_entropy"))
                .color(0x43435E)
                .ore().dust().fluid().gem()
                .flags(CRYSTALLIZABLE, GTQTMaterialFlags.GENERATE_BOULE)
                .iconSet(MaterialIconSet.SHINY)
        ...
        PollutionMaterials.InfusedOrder = new Material.Builder(getMaterialsId(), pollutionId("infused_order"))
                .color(0xEECCFF)
                .ore().dust().fluid().gem()
                .flags(CRYSTALLIZABLE, GTQTMaterialFlags.GENERATE_BOULE)
                .iconSet(MaterialIconSet.SHINY)
