...
public class BotaniaRecipes {
    ...
    private static void rune() {
        ...
        MagicRecipeProperties.manaPerTick(PORecipeMaps.MANA_RUNE_ALTAR_RECIPES.recipeBuilder()
                ...
                .input(OrePrefix.block, PollutionMaterials.AethericDarkSteel)
                .input(OrePrefix.block, PollutionMaterials.HyperdimensionalSilver)
                .input(PollutionMetaItems.PRECISION_RUNE_BLANK)
        ...
        MagicRecipeProperties.manaPerTick(PORecipeMaps.MANA_RUNE_ALTAR_RECIPES.recipeBuilder()
                ...
                .inputs(new ItemStack(ModItems.rune, 1, 9))
                .inputs(new ItemStack(ModItems.rune, 1, 10))
                .input(OrePrefix.block, PollutionMaterials.BloodOfAvernus)
    ...
    private static void manahatch() {
        ...
        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .input(MetaItems.SENSOR_LV.getMetaItem(), 2, 232)
                .fluidInputs(GTQTMaterials.Mana.getFluid(1000))
                .outputs(PollutionMetaTileEntities.MANA_POOL_INPUT_HATCH[0].getStackForm())
                .duration(100)
                .EUt(VA[LV])
                .buildAndRegister();
        ...
        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .input(MetaItems.SENSOR_LuV.getMetaItem(), 2, 237)
                .fluidInputs(PollutionMaterials.ErichAura.getFluid(1000))
                .outputs(PollutionMetaTileEntities.MANA_POOL_INPUT_HATCH[1].getStackForm())
                .duration(100)
                .EUt(VA[LuV])
                .buildAndRegister();
        ...
        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .input(MetaItems.SENSOR_UEV.getMetaItem(), 2, 241)
                .fluidInputs(PollutionMaterials.WhiteMansus.getFluid(1000))
                .outputs(PollutionMetaTileEntities.MANA_POOL_INPUT_HATCH[2].getStackForm())
                .duration(100)
                .EUt(VA[UEV])
                .buildAndRegister();
        ...
        // 无线升级所需的魔力谐振线圈
        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
                .inputs(new ItemStack(ModItems.spark))
                .inputs(new ItemStack(Items.ENDER_EYE))
                .input(OrePrefix.wireGtSingle, PollutionMaterials.Manasteel, 8)
                .input(OrePrefix.gear, PollutionMaterials.Mansussteel)
                .fluidInputs(GTQTMaterials.Mana.getFluid(1000))
                .output(PollutionMetaItems.MANA_RESONANCE_COIL)
                .duration(200)
                .EUt(VA[LV])
                .buildAndRegister();

        // 三档无线输入/输出仓由对应有线仓升级，方向不会改变
        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
                .inputs(PollutionMetaTileEntities.MANA_POOL_INPUT_HATCH[0].getStackForm())
                .input(PollutionMetaItems.MANA_RESONANCE_COIL)
                .input(MetaItems.SENSOR_LV.getMetaItem(), 2, 232)
                .fluidInputs(GTQTMaterials.Mana.getFluid(2000))
                .outputs(PollutionMetaTileEntities.WIRELESS_MANA_POOL_INPUT_HATCH[0].getStackForm())
                .duration(200)
                .EUt(VA[LV])
                .buildAndRegister();

        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
                .inputs(PollutionMetaTileEntities.MANA_POOL_OUTPUT_HATCH[0].getStackForm())
                .input(PollutionMetaItems.MANA_RESONANCE_COIL)
                .input(MetaItems.EMITTER_LV.getMetaItem(), 2, 217)
                .fluidInputs(GTQTMaterials.Mana.getFluid(2000))
                .outputs(PollutionMetaTileEntities.WIRELESS_MANA_POOL_OUTPUT_HATCH[0].getStackForm())
                .duration(200)
                .EUt(VA[LV])
                .buildAndRegister();

        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
                .inputs(PollutionMetaTileEntities.MANA_POOL_INPUT_HATCH[1].getStackForm())
                .input(PollutionMetaItems.MANA_RESONANCE_COIL, 2)
                .input(MetaItems.SENSOR_LuV.getMetaItem(), 2, 237)
                .fluidInputs(PollutionMaterials.ErichAura.getFluid(2000))
                .outputs(PollutionMetaTileEntities.WIRELESS_MANA_POOL_INPUT_HATCH[1].getStackForm())
                .duration(300)
                .EUt(VA[LuV])
                .buildAndRegister();

        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
                .inputs(PollutionMetaTileEntities.MANA_POOL_OUTPUT_HATCH[1].getStackForm())
                .input(PollutionMetaItems.MANA_RESONANCE_COIL, 2)
                .input(MetaItems.EMITTER_LuV.getMetaItem(), 2, 222)
                .fluidInputs(PollutionMaterials.ErichAura.getFluid(2000))
                .outputs(PollutionMetaTileEntities.WIRELESS_MANA_POOL_OUTPUT_HATCH[1].getStackForm())
                .duration(300)
                .EUt(VA[LuV])
                .buildAndRegister();

        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
                .inputs(PollutionMetaTileEntities.MANA_POOL_INPUT_HATCH[2].getStackForm())
                .input(PollutionMetaItems.MANA_RESONANCE_COIL, 4)
                .input(MetaItems.SENSOR_UEV.getMetaItem(), 2, 241)
                .fluidInputs(PollutionMaterials.WhiteMansus.getFluid(2000))
                .outputs(PollutionMetaTileEntities.WIRELESS_MANA_POOL_INPUT_HATCH[2].getStackForm())
                .duration(400)
                .EUt(VA[UEV])
                .buildAndRegister();

        PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
                .inputs(PollutionMetaTileEntities.MANA_POOL_OUTPUT_HATCH[2].getStackForm())
                .input(PollutionMetaItems.MANA_RESONANCE_COIL, 4)
                .input(MetaItems.EMITTER_UEV.getMetaItem(), 2, 226)
                .fluidInputs(PollutionMaterials.WhiteMansus.getFluid(2000))
                .outputs(PollutionMetaTileEntities.WIRELESS_MANA_POOL_OUTPUT_HATCH[2].getStackForm())
                .duration(400)
                .EUt(VA[UEV])
                .buildAndRegister();
    }
