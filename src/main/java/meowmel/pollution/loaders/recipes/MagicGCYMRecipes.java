...
import meowmel.gtqtcore.common.metatileentities.GTQTMetaTileEntities;
...
import static meowmel.pollution.api.recipes.PORecipeMaps.MAGIC_ALLOY_BLAST_RECIPES;
...
public class MagicGCYMRecipes {
	...
	private static void materials() {
		...
		EXTRACTOR_RECIPES.recipeBuilder()
				...
				.fluidOutputs(InfusedAir.getFluid(144))
				.duration(200)
				.EUt(30)
				.buildAndRegister();
		EXTRACTOR_RECIPES.recipeBuilder()
				.input(dust, InfusedFire, 1)
				.fluidOutputs(InfusedFire.getFluid(144))
				.duration(200)
				.EUt(30)
				.buildAndRegister();
		EXTRACTOR_RECIPES.recipeBuilder()
				.input(dust, InfusedWater, 1)
				.fluidOutputs(InfusedWater.getFluid(144))
				.duration(200)
				.EUt(30)
				.buildAndRegister();
		EXTRACTOR_RECIPES.recipeBuilder()
				.input(dust, InfusedEarth, 1)
				.fluidOutputs(InfusedEarth.getFluid(144))
				.duration(200)
				.EUt(30)
				.buildAndRegister();
		EXTRACTOR_RECIPES.recipeBuilder()
				.input(dust, InfusedOrder, 1)
				.fluidOutputs(InfusedOrder.getFluid(144))
				.duration(200)
				.EUt(30)
				.buildAndRegister();
		EXTRACTOR_RECIPES.recipeBuilder()
				.input(dust, InfusedEntropy, 1)
				.fluidOutputs(InfusedEntropy.getFluid(144))
				.duration(200)
				.EUt(30)
				.buildAndRegister();
		...
		RecipeMaps.MACERATOR_RECIPES.recipeBuilder()
				...
				.output(dust, InfusedAir)
				.duration(20)
				.EUt(120)
				.buildAndRegister();
		RecipeMaps.MACERATOR_RECIPES.recipeBuilder()
				.input(BlocksTC.crystalFire)
				.output(dust, InfusedFire)
				.duration(20)
				.EUt(120)
				.buildAndRegister();
		RecipeMaps.MACERATOR_RECIPES.recipeBuilder()
				.input(BlocksTC.crystalWater)
				.output(dust, InfusedWater)
				.duration(20)
				.EUt(120)
				.buildAndRegister();
		RecipeMaps.MACERATOR_RECIPES.recipeBuilder()
				.input(BlocksTC.crystalEarth)
				.output(dust, InfusedEarth)
				.duration(20)
				.EUt(120)
				.buildAndRegister();
		RecipeMaps.MACERATOR_RECIPES.recipeBuilder()
				.input(BlocksTC.crystalOrder)
				.output(dust, InfusedOrder)
				.duration(20)
				.EUt(120)
				.buildAndRegister();
		RecipeMaps.MACERATOR_RECIPES.recipeBuilder()
				.input(BlocksTC.crystalEntropy)
				.output(dust, InfusedEntropy)
				.duration(20)
				.EUt(120)
				.buildAndRegister();
		RecipeMaps.AUTOCLAVE_RECIPES.recipeBuilder()
				.fluidInputs(InfusedAir.getFluid(144))
				.output(BlocksTC.crystalAir)
				.duration(200)
				.EUt(120)
				.buildAndRegister();
		RecipeMaps.AUTOCLAVE_RECIPES.recipeBuilder()
				.fluidInputs(InfusedFire.getFluid(144))
				.output(BlocksTC.crystalFire)
				.duration(200)
				.EUt(120)
				.buildAndRegister();
		RecipeMaps.AUTOCLAVE_RECIPES.recipeBuilder()
				.fluidInputs(InfusedWater.getFluid(144))
				.output(BlocksTC.crystalWater)
				.duration(200)
				.EUt(120)
				.buildAndRegister();
		RecipeMaps.AUTOCLAVE_RECIPES.recipeBuilder()
				.fluidInputs(InfusedEarth.getFluid(144))
		...
		RecipeMaps.MIXER_RECIPES.recipeBuilder()
				...
				.input(dust, PollutionMaterials.InfusedAir, 5)
		...
		RecipeMaps.MIXER_RECIPES.recipeBuilder()
				...
				.input(dust, PollutionMaterials.InfusedFire, 5)
		...
		RecipeMaps.MIXER_RECIPES.recipeBuilder()
				...
				.input(dust, PollutionMaterials.InfusedWater, 5)
		...
		RecipeMaps.MIXER_RECIPES.recipeBuilder()
				...
				.input(dust, Boron, 1)
				.input(dust, Carbon, 1)
				.input(dust, PollutionMaterials.InfusedEarth, 5)
		...
		RecipeMaps.MIXER_RECIPES.recipeBuilder()
				...
				.input(dust, Gold, 1)
				.input(dust, PollutionMaterials.InfusedOrder, 5)
		...
		RecipeMaps.MIXER_RECIPES.recipeBuilder()
				...
				.input(dust, PollutionMaterials.InfusedEntropy, 5)
		...
		MAGIC_ALLOY_BLAST_RECIPES.recipeBuilder()
				.input(dust, Iron, 1)
				.input(dust, InfusedEarth, 10)
				.input(dust, InfusedFire, 5)
				.input(dust, InfusedAir, 5)
		...
		RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder()
				...
				.buildAndRegister();
		//转换矩阵
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Pollution.MODID, "InfusedExchange"), new InfusionRecipe(
				"INFUSION@2",
		...
		MAGIC_GREENHOUSE_RECIPES.recipeBuilder()
				...
				.fluidInputs(InfusedEarth.getFluid(288))
		...
		//不纯魔力搅拌
		RecipeMaps.MIXER_RECIPES.recipeBuilder()
				.input(dust, PollutionMaterials.InfusedOrder)
				.input(dust, PollutionMaterials.InfusedEntropy)
				...
				.buildAndRegister();
		RecipeMaps.MIXER_RECIPES.recipeBuilder()
				.input(dust, PollutionMaterials.InfusedAir)
				.input(dust, PollutionMaterials.InfusedEarth)
				.fluidOutputs(PollutionMaterials.Impuremana.getFluid(48))
				.circuitMeta(1)
				.duration(100)
				.EUt(120)
				.buildAndRegister();
		RecipeMaps.MIXER_RECIPES.recipeBuilder()
				.input(dust, PollutionMaterials.InfusedFire)
				.input(dust, PollutionMaterials.InfusedWater)
				.fluidOutputs(PollutionMaterials.Impuremana.getFluid(48))
				.circuitMeta(1)
				.duration(100)
				.EUt(120)
		...
		RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder()
				...
				.input(plate, HyperdimensionalSilver, 4)
				.input(frameGt, Mansussteel,1)
				.circuitMeta(16)
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				...
				.fluidInputs(GTQTMaterials.Mana.getFluid(1000))
				.outputs(MetaTileEntities.PARALLEL_HATCH[0].getStackForm(4))
				.duration(800)
				.EUt(7680)
				.buildAndRegister();
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				...
				.input(frameGt, Mansussteel, 4)
				.fluidInputs(GTQTMaterials.Mana.getFluid(1000))
				.outputs(MetaTileEntities.PARALLEL_HATCH[1].getStackForm(4))
				.duration(800)
				.EUt(30720)
				.buildAndRegister();
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				...
				.input(frameGt, Mansussteel, 4)
				.fluidInputs(GTQTMaterials.Mana.getFluid(1000))
				.outputs(MetaTileEntities.PARALLEL_HATCH[2].getStackForm(4))
				.duration(800)
				.EUt(122880)
				.buildAndRegister();
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				...
				.input(frameGt, Mansussteel, 4)
				.fluidInputs(GTQTMaterials.Mana.getFluid(1000))
				.outputs(MetaTileEntities.PARALLEL_HATCH[3].getStackForm(4))
				.duration(800)
				.EUt(491520)
				.buildAndRegister();
		//炼金枢纽
		...
		//bot集气
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.inputs(MetaTileEntities.LARGE_GAS_COLLECTOR.getStackForm(16))
		...
		//bot冰箱
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.inputs(MetaTileEntities.VACUUM_FREEZER.getStackForm(16))
				.input(circuit, MarkerMaterials.Tier.IV, 16)
				.input(MetaItems.FIELD_GENERATOR_IV.getMetaItem(), 4, 206)
				.input(MetaItems.ELECTRIC_PUMP_IV, 16)
				.input(plate, Terrasteel, 32)
				.input(frameGt, HyperdimensionalSilver, 4)
				.input(gear, KQGold, 4)
				.fluidInputs(GTQTMaterials.Mana.getFluid(10000))
		...
		ASSEMBLY_LINE_RECIPES.recipeBuilder()
				...
				.input(plateDense, Terrasteel, 32)
				.input(cableGtHex, KQGold, 16)
				.fluidInputs(PollutionMaterials.ErichAura.getFluid(64000))
				.fluidInputs(UUMatter.getFluid(128000))
				.fluidInputs(GTQTMaterials.Orichalcum.getFluid(64000))
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				...
				.input(plate, GTQTMaterials.Thaumium, 48)
				.fluidInputs(GTQTMaterials.Mana.getFluid(1000))
		...
		MagicRecipeProperties.magic(PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(stickLong, AethericDarkSteel, 2)
				.input(frameGt, AethericDarkSteel, 1)
				.input(plate, IizunamaruElectrum, 8)
				.input(gear, IizunamaruElectrum, 4)
		...
		//自动反诘装置
		MagicRecipeProperties.magic(PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(gear, BloodOfAvernus, 6)
				.input(gearSmall, BloodOfAvernus, 4)
				.input(stickLong, IizunamaruElectrum, 4)
				.input(stick, AethericDarkSteel, 4)
		...
		//太一燃素瓶
		MagicRecipeProperties.magic(PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(rotor, IizunamaruElectrum, 2)
				.input(gearSmall, BloodOfAvernus, 4)
				.input(ring, IizunamaruElectrum, 32)
				.input(screw, AethericDarkSteel, 12)
				.input(plate, GTQTMaterials.VoidMetal, 8)
				.input(CORE_OF_IDEA, 2)
		...
		//四因阐释器
		MagicRecipeProperties.magic(PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(plate, IizunamaruElectrum, 16)
				.input(plate, BloodOfAvernus, 16)
				.input(plate, AethericDarkSteel, 16)
				.input(plate, GTQTMaterials.VoidMetal, 16)
				.input(ItemsTC.causalityCollapser, 4)
				.input(MetaItems.ROBOT_ARM_LuV, 2)
				.input(CORE_OF_IDEA, 2)
				.input(AUTO_ELENCHUS_DEVICE)
				.fluidInputs(DimensionalTransformingAgent.getFluid(8000))
				.fluidInputs(BlackMansus.getFluid(8000))
				.fluidInputs(WhiteMansus.getFluid(8000))
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				...
				.input(frameGt, HyperdimensionalSilver, 16)
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				...
				.input(frameGt, BloodOfAvernus, 16)
		...
		//casing
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(frameGt, BloodOfAvernus, 1)
				.input(MetaItems.ELECTRIC_MOTOR_IV, 2)
				.input(rotor, IizunamaruElectrum, 2)
				.input(BLOOD_CIRCUIT_IV)
				.input(plate, BindingMetal, 16)
				.input(wireGtSingle, Platinum, 16)
				.fluidInputs(CryogenicSyntheticBlood.getFluid(1000))
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(frameGt, BloodOfAvernus, 1)
				.input(plate, BloodOfAvernus, 6)
				.input(BLOOD_CIRCUIT_LuV)
				.input(wireFine, IizunamaruElectrum, 32)
				.input(wireFine, AethericDarkSteel, 32)
				.input(wireGtSingle, NiobiumTitanium, 16)
				.fluidInputs(SyntheticComputationalBlood.getFluid(1000))
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				...
				.input(wireFine, SentientMetal, 32)
				.input(wireFine, BindingMetal, 32)
				.input(wireGtSingle, VanadiumGallium, 16)
				.fluidInputs(SyntheticComputationalBlood.getFluid(2000))
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				...
				.input(wireFine, ExistingNexus, 32)
				.input(wireFine, FadingNexus, 32)
				.input(wireGtSingle, YttriumBariumCuprate, 16)
				.fluidInputs(SyntheticComputationalBlood.getFluid(4000))
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(frameGt, BloodOfAvernus, 1)
				.input(plate, BloodOfAvernus, 6)
				.input(screw, GTQTMaterials.VoidMetal, 8)
				.input(BLOOD_CIRCUIT_IV)
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(PollutionMetaTileEntities.BMHPCA_EMPTY_COMPONENT)
				.input(stickLong, IizunamaruElectrum, 8)
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(PollutionMetaTileEntities.BMHPCA_EMPTY_COMPONENT)
				.input(stickLong, BindingMetal, 8)
				.input(rotor, Tritanium, 4)
				.input(MetaItems.ELECTRIC_MOTOR_ZPM)
				.input(ELUCIDATOR_OF_FOUR_CAUSES)
				.fluidInputs(CryogenicSyntheticBlood.getFluid(2000))
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(PollutionMetaTileEntities.BMHPCA_EMPTY_COMPONENT)
				.input(stickLong, FadingNexus, 8)
				.input(rotor, GTQTMaterials.Adamantium, 4)
				.input(MetaItems.ELECTRIC_MOTOR_UV)
				.input(ELUCIDATOR_OF_FOUR_CAUSES)
				.fluidInputs(CryogenicSyntheticBlood.getFluid(4000))
		...
		PORecipeMaps.MAGIC_ASSEMBLER_RECIPES.recipeBuilder()
				.input(PollutionMetaTileEntities.BMHPCA_EMPTY_COMPONENT)
				.input(plateDouble, SentientMetal, 8)
