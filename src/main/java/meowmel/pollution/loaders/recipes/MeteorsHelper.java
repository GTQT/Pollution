...
public class MeteorsHelper {
    ...
    private static void initMeteors() {
        ...
        registerMeteor(
                ...
                2,
                400000,
                PollutionMaterials.InfusedAir, 100,
                PollutionMaterials.InfusedFire, 100,
                PollutionMaterials.InfusedWater, 100,
                PollutionMaterials.InfusedEarth, 100,
                PollutionMaterials.InfusedEntropy, 100,
                PollutionMaterials.InfusedOrder, 100
        );
        registerMeteor(
