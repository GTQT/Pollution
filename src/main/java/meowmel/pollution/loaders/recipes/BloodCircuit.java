...
public class BloodCircuit {
    public static void init() {
        ...
        addBloodAltarEx(MAGIC_CIRCUIT_BOARD_ULV.getStackForm(1),BLOOD_PORT.getStackForm(1), 3);
