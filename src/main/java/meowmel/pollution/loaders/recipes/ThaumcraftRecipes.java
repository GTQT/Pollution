...
/*
    ...
    */
    ...
    private static void catalyst() {
        ...
        //强制魔导催化
        PORecipeMaps.MAGIC_CHEMICAL_REACTOR_RECIPES.recipeBuilder()
                .fluidInputs(PollutionMaterials.InfusedWater.getFluid(9216))
                .fluidInputs(PollutionMaterials.InfusedFire.getFluid(9216))
                .fluidInputs(PollutionMaterials.InfusedOrder.getFluid(9216))
                .fluidInputs(PollutionMaterials.InfusedAir.getFluid(9216))
    ...
    private static void misc() {
        ...
        RecipeMaps.ARC_FURNACE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(PollutionMaterials.InfusedExchange.getFluid(1440))
