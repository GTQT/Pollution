...
public class MetaTileEntityInfusedExchange extends MetaTileEntityBaseWithControl {
    ...
    public int number = 0;
    FluidStack AIR_STACK = PollutionMaterials.InfusedAir.getFluid(144);
    FluidStack FIRE_STACK = PollutionMaterials.InfusedFire.getFluid(144);
    FluidStack WATER_STACK = PollutionMaterials.InfusedWater.getFluid(144);
    FluidStack ERATH_STACK = PollutionMaterials.InfusedEarth.getFluid(144);
    FluidStack ORDER_STACK = PollutionMaterials.InfusedOrder.getFluid(144);
    FluidStack ENTROPY_STACK = PollutionMaterials.InfusedEntropy.getFluid(144);
