...
import static meowmel.pollution.api.recipes.PORecipeMaps.MANA_PETAL_RECIPES;

public class MetaTileEntityManaPetalApothecary extends ManaMultiblockController {
