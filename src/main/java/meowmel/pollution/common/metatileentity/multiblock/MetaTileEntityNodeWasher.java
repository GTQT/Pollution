...
public class MetaTileEntityNodeWasher extends MetaTileEntityBaseWithControl {
    ...
    //六种流体
    private final FluidStack INFUSED_AIR = PollutionMaterials.InfusedAir.getFluid(1);
    private final FluidStack INFUSED_FIRE = PollutionMaterials.InfusedFire.getFluid(1);
    private final FluidStack INFUSED_EARTH = PollutionMaterials.InfusedEarth.getFluid(1);
    private final FluidStack INFUSED_WATER = PollutionMaterials.InfusedWater.getFluid(1);
    private final FluidStack INFUSED_ORDER = PollutionMaterials.InfusedOrder.getFluid(1);
    private final FluidStack INFUSED_ENTROPY = PollutionMaterials.InfusedEntropy.getFluid(1);
    //计时器，洗点时间
