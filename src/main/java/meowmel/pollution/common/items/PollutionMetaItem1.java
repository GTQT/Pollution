...
import static meowmel.pollution.common.CommonProxy.Pollution_TAROT;
...
public class PollutionMetaItem1 extends StandardMetaItem {
	...
	public void registerSubItems() {
		...
		//过滤器注册（5个）
		PollutionMetaItems.FILTER_MKI = this.addItem(210, "filter.i").setMaxStackSize(8).addComponents(new FilterBehavior(240000, 1, PollutionMaterials.InfusedEarth)).setCreativeTabs(Pollution_TAB);
		PollutionMetaItems.FILTER_MKII = this.addItem(211, "filter.ii").setMaxStackSize(8).addComponents(new FilterBehavior(360000, 2, PollutionMaterials.InfusedWater)).setCreativeTabs(Pollution_TAB);
