package meowmel.pollution.client.gui.QuantumAspectTank;
...
public class AspectImageWidget extends ClickButtonWidget {
    ...
    protected final Consumer<ClickAspectData> onPressCallbackA;
    ...
    public static final class ClickAspectData {
        ...
        public static ClickAspectData readFromBuf(PacketBuffer buf) {
            ...
            return new ClickAspectData(button, shiftClick, ctrlClick, isClient, aspect);
        }
    }
}
